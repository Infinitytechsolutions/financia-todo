  ...
  return (
    <div className='footer'>
        ...
        <div className='footer-mid'>
            ...
            <NavLink className="footer-menu" to="/sobre-nosotros">Sobe Nosotros</NavLink>
        </div>
        <div className='footer-right'>
            <h3>TÉRMINOS Y CONDICIONES DEL PRÉSTAMO</h3>
            <p>El porcentaje de la tasa de interés siempre será la misma durante todo el plazo del préstamo. Esto permite que el monto de la letra no cambie. Nuestra tasa efectuva anual va desde el 165% al 177%, según perfil del cliente. Nuestros plazos desde los 3 y hasta los 18 meses, además le financiaremos los gastos de formalización, los cuales van incluidos en el préstamo otorgado.</p>
